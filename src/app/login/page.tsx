  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center px-5 py-10">
      <div className="w-full max-w-[420px] relative z-10">
        ...
        {/* Card */}
        <div className="bg-surface/[0.35] border border-border/50 rounded-2xl p-6 sm:p-8 backdrop-blur-2xl shadow-[0_8px_40px_rgba(0,0,0,0.35),inset_0_1px_0_0_rgba(255,255,255,0.08),inset_0_-1px_0_0_rgba(0,0,0,0.2)] bg-gradient-to-b from-white/[0.03] to-transparent">
