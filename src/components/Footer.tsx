      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6 py-8 sm:py-10">
        ...
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="w-fit mx-auto flex flex-col items-center gap-2">
            <div className="relative flex items-center justify-center w-[22px] h-[22px] overflow-hidden">
              <Image src="/logotipo.png" alt="Swapture" fill sizes="22px" className="object-contain mix-blend-screen" />
            </div>
