        ...
        <div className="grid sm:grid-cols-2 gap-3 sm:gap-5">
          {problems.map((item, i) => (
            <Reveal key={item.title} delay={i + 3}>
              <div className="group relative p-4 sm:p-7 rounded-2xl border border-border/60 bg-surface/25 shadow-[0_8px_30px_rgba(0,0,0,0.25)] hover:border-accent/30 hover:shadow-[0_12px_40px_rgba(0,0,0,0.35)] transition-all duration-500 h-full text-center sm:text-left">
